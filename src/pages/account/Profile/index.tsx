        ...
        <div className="w-full lg:w-1/4">
          ...
          <ul className="mt-5 flex flex-col gap-2">
            <li
              ...
              className={`font-bold cursor-pointer hover:text-[#a3a3a3] w-fit ${
                activeTab === 1 ? "text-[#a3a3a3]" : ""
              }`}
            >
              Thông tin tài khoản
            </li>
            <li
              ...
              className={`font-bold cursor-pointer hover:text-[#a3a3a3] w-fit ${
                activeTab === 2 ? "text-[#a3a3a3]" : ""
              }`}
            >
              Đổi mật khẩu
            </li>
            <li className="font-bold cursor-pointer hover:text-[#a3a3a3] w-fit">
              Đăng xuất
            </li>
          </ul>
        </div>
